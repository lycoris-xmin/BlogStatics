      ...
      _createClass(BootstrapTable, [
            ...
            this.options.columns.forEach(function (columns, i) {
              ...
              columns.forEach(function (column, j) {
                ...
                html.push(
                  ...
                  column.checkbox || column.radio ? Utils.sprintf(' class="bs-checkbox %s"', column['class'] || '') : classes || class_,
                ...
                if (column.checkbox) {
                  ...
                  if (!_this2.options.singleSelect && _this2.options.checkboxHeader) {
                    text =
                      ...
                      '  <input type="checkbox" class="custom-control-input" name="btSelectAll" id="' +
                      cf +
                      '">' +
          ...
          value: function initToolbar() {
            ...
            var buttonsHtml = {
              ...
              columns: (function () {
                ...
                html.push(
                  '<div class="keep-open '
                    .concat(_this4.constants.classes.buttonsDropdown, '" title="')
                    .concat(opts.formatColumns(), '">\n          <button class="')
                    .concat(_this4.constants.buttonsClass, ' dropdown-toggle" type="button" data-toggle="dropdown"\n          aria-label="Columns" title="')
                    .concat(opts.formatColumns(), '">\n          ')
                ...
                if (opts.showColumnsSearch) {
                  html.push(
                    Utils.sprintf(
                      ...
                      Utils.sprintf('<input type="text" class="%s" id="columnsSearch" placeholder="%s" autocomplete="off">', _this4.constants.classes.input, opts.formatSearch())
                    )
                  );
                ...
                if (opts.showColumnsToggleAll) {
                  ...
                  html.push(
                    Utils.sprintf(
                      _this4.constants.html.toolbarDropdownItem,
                      Utils.sprintf(
                        '<div class="custom-control custom-checkbox"><input type="checkbox" class="toggle-all custom-control-input" id="toggle-all" %s> <label class="custom-control-label" for="toggle-all">%s</label></div>',
                  ...
                  if (column.switchable) {
                    html.push(
                      Utils.sprintf(
                        _this4.constants.html.toolbarDropdownItem,
                        Utils.sprintf(
                          '<div class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input" data-field="%s" id="%s" value="%s"%s%s> <label  class="custom-control-label" for="%s">%s</label></div>',
                          column.field,
                          column.field,
                          i,
                          checked,
        ...
        },
        {
          ...
          value: function initPagination() {
            ...
            html.push(
              '<div class="'.concat(this.constants.classes.pull, '-').concat(opts.paginationDetailHAlign, ' pagination-detail">\n      <span class="pagination-info">\n      ').concat(paginationInfo, '\n      </span>')
            );
            ...
            if (!opts.onlyInfoPagination) {
              ...
              html.push('</span></div>');
              html.push(
                '<div class="'.concat(this.constants.classes.pull, '-').concat(opts.paginationHAlign, ' pagination">'),
                ...
                text = [
                  ...
                  '<div class="custom-control custom-checkbox">\n            <input\n            class="custom-control-input"             id="' +
                    ...
                    '-'
                      .concat(i, '"data-index="')
                      .concat(i, '"\n            name="')
                      .concat(_this7.options.selectItemName, '"\n            type="')
                      .concat(type, '"\n            ')
          ...
          value: function getCaret() {
            ...
            this.$header.find('th').each(function (i, th) {
              $(th)
                ...
                .addClass($(th).data('field') === _this11.options.sortName ? _this11.options.sortOrder : 'both');
            });
          }
        },
        {
